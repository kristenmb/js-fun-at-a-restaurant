...
inStock = inStock * 2;
// console.log(inStock); //checking work
...
//console.log(shouldOrderMore); //checking work
...
if (inStock >= 1) {
  console.log(`I am going to eat some ${food}!`);
} else {
...
var vegetables = ['cauliflower', 'bell pepper', 'zucchini', 'green onion', 'carrot'];
...
var fruits = ['grapes', 'bananas', 'cumquats', 'oranges', 'strawberries', 'rambutans', 'kiwi'];
